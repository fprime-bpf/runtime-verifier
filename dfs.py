...
BPF_INFO: Dict[int, OpInfo] = {
    ...
    BpfCode.JMP.CALL | BpfS.K | BpfClass.JMP:   OpInfo("CALL",    87),
    BpfCode.JMP.CALL | BpfS.X | BpfClass.JMP:   OpInfo("CALL",    87),
    ...
    BpfCode.JMP.CALL | BpfS.K | BpfClass.JMP32: OpInfo("CALL", 87),
    BpfCode.JMP.CALL | BpfS.X | BpfClass.JMP32: OpInfo("CALL", 87),
    ...
    BpfMode.FMEM  | BpfSize.W  | BpfClass.LD: OpInfo("FLD_W",  3),
    BpfMode.FMEM  | BpfSize.H  | BpfClass.LD: OpInfo("FLD_H",  3),
    BpfMode.FMEM  | BpfSize.B  | BpfClass.LD: OpInfo("FLD_B",  3),
    BpfMode.FMEM  | BpfSize.DW | BpfClass.LD: OpInfo("FLD_DW",  3),
    ...
    BpfMode.FMEM  | BpfSize.W  | BpfClass.LDX: OpInfo("FLDX_W",  3),
    BpfMode.FMEM  | BpfSize.H  | BpfClass.LDX: OpInfo("FLDX_H",  3),
    BpfMode.FMEM  | BpfSize.B  | BpfClass.LDX: OpInfo("FLDX_B",  3),
    BpfMode.FMEM  | BpfSize.DW | BpfClass.LDX: OpInfo("FLDX_DW",  3),
    ...
    BpfMode.FMEM  | BpfSize.W  | BpfClass.ST: OpInfo("FST_W",  1),
    BpfMode.FMEM  | BpfSize.H  | BpfClass.ST: OpInfo("FST_H",  1),
    BpfMode.FMEM  | BpfSize.B  | BpfClass.ST: OpInfo("FST_B",  1),
    BpfMode.FMEM  | BpfSize.DW | BpfClass.ST: OpInfo("FST_DW",  1),
    ...
    BpfMode.FMEM  | BpfSize.W  | BpfClass.STX: OpInfo("FSTX_W",  1),
    BpfMode.FMEM  | BpfSize.H  | BpfClass.STX: OpInfo("FSTX_H",  1),
    BpfMode.FMEM  | BpfSize.B  | BpfClass.STX: OpInfo("FSTX_B",  1),
    BpfMode.FMEM  | BpfSize.DW | BpfClass.STX: OpInfo("FSTX_DW",  1),
