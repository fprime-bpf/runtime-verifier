...
BPF_INFO: Dict[int, InstrInfo] = {
    ...
    BpfCode.ALU.MUL  | BpfS.K | BpfClass.ALU:   InstrInfo("MUL_K",   6),
    BpfCode.ALU.MUL  | BpfS.X | BpfClass.ALU:   InstrInfo("MUL_X",   2),
    BpfCode.ALU.DIV  | BpfS.K | BpfClass.ALU:   InstrInfo("DIV_K",   19),
    BpfCode.ALU.DIV  | BpfS.X | BpfClass.ALU:   InstrInfo("DIV_X",   15),
    BpfCode.ALU.MOD  | BpfS.K | BpfClass.ALU:   InstrInfo("MOD_K",   19),
    BpfCode.ALU.MOD  | BpfS.X | BpfClass.ALU:   InstrInfo("MOD_X",   15),
    ...
    BpfCode.ALU.NEG  | BpfS.K | BpfClass.ALU:   InstrInfo("NEG_K",   1),
    BpfCode.ALU.NEG  | BpfS.X | BpfClass.ALU:   InstrInfo("NEG_X",   1),
    ...
    BpfCode.ALU.MOV  | BpfS.X | BpfClass.ALU:   InstrInfo("MOV_X",   2),
    ...
    BpfCode.ALU.MUL  | BpfS.K | BpfClass.ALU64: InstrInfo("MUL64_K", 6),
    BpfCode.ALU.MUL  | BpfS.X | BpfClass.ALU64: InstrInfo("MUL64_X", 2),
    BpfCode.ALU.DIV  | BpfS.K | BpfClass.ALU64: InstrInfo("DIV64_K", 19),
    BpfCode.ALU.DIV  | BpfS.X | BpfClass.ALU64: InstrInfo("DIV64_X", 15),
    BpfCode.ALU.MOD  | BpfS.K | BpfClass.ALU64: InstrInfo("MOD64_K", 19),
    BpfCode.ALU.MOD  | BpfS.X | BpfClass.ALU64: InstrInfo("MOD64_X", 15),
    ...
    BpfCode.ALU.NEG  | BpfS.K | BpfClass.ALU64: InstrInfo("NEG64_K", 1),
    BpfCode.ALU.NEG  | BpfS.X | BpfClass.ALU64: InstrInfo("NEG64_X", 1),
    ...
    BpfCode.ALU.MOV  | BpfS.X | BpfClass.ALU64: InstrInfo("MOV64_X", 2),
    ...
    BpfCode.JMP.JEQ  | BpfS.K | BpfClass.JMP:   InstrInfo("JEQ_K",   8),
    BpfCode.JMP.JEQ  | BpfS.X | BpfClass.JMP:   InstrInfo("JEQ_X",   4),
    BpfCode.JMP.JGT  | BpfS.K | BpfClass.JMP:   InstrInfo("JGT_K",   8),
    BpfCode.JMP.JGT  | BpfS.X | BpfClass.JMP:   InstrInfo("JGT_X",   4),
    BpfCode.JMP.JGE  | BpfS.K | BpfClass.JMP:   InstrInfo("JGE_K",   8),
    BpfCode.JMP.JGE  | BpfS.X | BpfClass.JMP:   InstrInfo("JGE_X",   4),
    BpfCode.JMP.JNE  | BpfS.K | BpfClass.JMP:   InstrInfo("JNE_K",   8),
    BpfCode.JMP.JNE  | BpfS.X | BpfClass.JMP:   InstrInfo("JNE_X",   4),
    BpfCode.JMP.JSET | BpfS.K | BpfClass.JMP:   InstrInfo("JSET_K",  10),
    BpfCode.JMP.JSET | BpfS.X | BpfClass.JMP:   InstrInfo("JSET_X",  6),
    BpfCode.JMP.JSGT | BpfS.K | BpfClass.JMP:   InstrInfo("JSGT_K",  8),
    BpfCode.JMP.JSGT | BpfS.X | BpfClass.JMP:   InstrInfo("JSGT_X",  4),
    BpfCode.JMP.JSGE | BpfS.K | BpfClass.JMP:   InstrInfo("JSGE_K",  8),
    BpfCode.JMP.JSGE | BpfS.X | BpfClass.JMP:   InstrInfo("JSGE_X",  4),
    BpfCode.JMP.JLT  | BpfS.K | BpfClass.JMP:   InstrInfo("JLT_K",   8),
    BpfCode.JMP.JLT  | BpfS.X | BpfClass.JMP:   InstrInfo("JLT_X",   4),
    BpfCode.JMP.JLE  | BpfS.K | BpfClass.JMP:   InstrInfo("JLE_K",   8),
    BpfCode.JMP.JLE  | BpfS.X | BpfClass.JMP:   InstrInfo("JLE_X",   4),
    BpfCode.JMP.JSLT | BpfS.K | BpfClass.JMP:   InstrInfo("JSLT_K",  8),
    BpfCode.JMP.JSLT | BpfS.X | BpfClass.JMP:   InstrInfo("JSLT_X",  4),
    BpfCode.JMP.JSLE | BpfS.K | BpfClass.JMP:   InstrInfo("JSLE_K",  8),
    BpfCode.JMP.JSLE | BpfS.X | BpfClass.JMP:   InstrInfo("JSLE_X",  4),
    ...
    BpfCode.JMP.JEQ  | BpfS.K | BpfClass.JMP32: InstrInfo("JEQ32_K", 8),
    BpfCode.JMP.JEQ  | BpfS.X | BpfClass.JMP32: InstrInfo("JEQ32_X", 4),
    BpfCode.JMP.JNE  | BpfS.K | BpfClass.JMP32: InstrInfo("JNE32_K", 8),
    BpfCode.JMP.JNE  | BpfS.X | BpfClass.JMP32: InstrInfo("JNE32_X", 4),
    BpfCode.JMP.JGT  | BpfS.K | BpfClass.JMP32: InstrInfo("JGT32_K", 8),
    BpfCode.JMP.JGT  | BpfS.X | BpfClass.JMP32: InstrInfo("JGT32_X", 4),
    BpfCode.JMP.JGE  | BpfS.K | BpfClass.JMP32: InstrInfo("JGE32_K", 8),
    BpfCode.JMP.JGE  | BpfS.X | BpfClass.JMP32: InstrInfo("JGE32_X", 4),
    BpfCode.JMP.JSET | BpfS.K | BpfClass.JMP32: InstrInfo("JSET32_K", 10),
    BpfCode.JMP.JSET | BpfS.X | BpfClass.JMP32: InstrInfo("JSET32_X", 6),
    BpfCode.JMP.JLT  | BpfS.K | BpfClass.JMP32: InstrInfo("JLT32_K", 8),
    BpfCode.JMP.JLT  | BpfS.X | BpfClass.JMP32: InstrInfo("JLT32_X", 4),
    BpfCode.JMP.JLE  | BpfS.K | BpfClass.JMP32: InstrInfo("JLE32_K", 8),
    BpfCode.JMP.JLE  | BpfS.X | BpfClass.JMP32: InstrInfo("JLE32_X", 4),
    BpfCode.JMP.JSGT | BpfS.K | BpfClass.JMP32: InstrInfo("JSGT32_K", 8),
    BpfCode.JMP.JSGT | BpfS.X | BpfClass.JMP32: InstrInfo("JSGT32_X", 4),
    BpfCode.JMP.JSGE | BpfS.K | BpfClass.JMP32: InstrInfo("JSGE32_K", 8),
    BpfCode.JMP.JSGE | BpfS.X | BpfClass.JMP32: InstrInfo("JSGE32_X", 4),
    BpfCode.JMP.JSLT | BpfS.K | BpfClass.JMP32: InstrInfo("JSLT32_K", 8),
    BpfCode.JMP.JSLT | BpfS.X | BpfClass.JMP32: InstrInfo("JSLT32_X", 4),
    BpfCode.JMP.JSLE | BpfS.K | BpfClass.JMP32: InstrInfo("JSLE32_K", 8),
    BpfCode.JMP.JSLE | BpfS.X | BpfClass.JMP32: InstrInfo("JSLE32_X", 4),
    ...
    (BpfMode.ATOMIC | BpfSize.DW | BpfClass.STX) | ((ATOMIC_CMPXCHG      ) << 8): InstrInfo("ATOMIC_CMPXCHG_DW", 17),
}


BPF_INFO_FPU: Dict[int, InstrInfo] = {
    # ===== FPU32 (Single Precision) =====
    BpfCode.ALU.ADD  | BpfS.K | BpfClass.ALU:   InstrInfo("FADD_K",   20),
    BpfCode.ALU.ADD  | BpfS.X | BpfClass.ALU:   InstrInfo("FADD_X",   16),
    BpfCode.ALU.SUB  | BpfS.K | BpfClass.ALU:   InstrInfo("FSUB_K",   20),
    BpfCode.ALU.SUB  | BpfS.X | BpfClass.ALU:   InstrInfo("FSUB_X",   16),
    BpfCode.ALU.MUL  | BpfS.K | BpfClass.ALU:   InstrInfo("FMUL_K",   26),
    BpfCode.ALU.MUL  | BpfS.X | BpfClass.ALU:   InstrInfo("FMUL_X",   22),
    BpfCode.ALU.DIV  | BpfS.K | BpfClass.ALU:   InstrInfo("FDIV_K",   44),
    BpfCode.ALU.DIV  | BpfS.X | BpfClass.ALU:   InstrInfo("FDIV_X",   40),
    BpfCode.ALU.NEG  | BpfS.K | BpfClass.ALU:   InstrInfo("FNEG_K",   16),
    BpfCode.ALU.NEG  | BpfS.X | BpfClass.ALU:   InstrInfo("FNEG_X",   16),
    BpfCode.ALU.MOV  | BpfS.K | BpfClass.ALU:   InstrInfo("FMOV_K",   4),
    BpfCode.ALU.MOV  | BpfS.X | BpfClass.ALU:   InstrInfo("FMOV_X",   4),
    
    # ===== FPU64 (Double precision) =====
    BpfCode.ALU.ADD  | BpfS.K | BpfClass.ALU64:   InstrInfo("FADD64_K",   20),
    BpfCode.ALU.ADD  | BpfS.X | BpfClass.ALU64:   InstrInfo("FADD64_X",   16),
    BpfCode.ALU.SUB  | BpfS.K | BpfClass.ALU64:   InstrInfo("FSUB64_K",   20),
    BpfCode.ALU.SUB  | BpfS.X | BpfClass.ALU64:   InstrInfo("FSUB64_X",   16),
    BpfCode.ALU.MUL  | BpfS.K | BpfClass.ALU64:   InstrInfo("FMUL64_K",   26),
    BpfCode.ALU.MUL  | BpfS.X | BpfClass.ALU64:   InstrInfo("FMUL64_X",   22),
    BpfCode.ALU.DIV  | BpfS.K | BpfClass.ALU64:   InstrInfo("FDIV64_K",   44),
    BpfCode.ALU.DIV  | BpfS.X | BpfClass.ALU64:   InstrInfo("FDIV64_X",   40),
    BpfCode.ALU.NEG  | BpfS.K | BpfClass.ALU64:   InstrInfo("FNEG64_K",   16),
    BpfCode.ALU.NEG  | BpfS.X | BpfClass.ALU64:   InstrInfo("FNEG64_X",   16),
    BpfCode.ALU.MOV  | BpfS.K | BpfClass.ALU64:   InstrInfo("FMOV64_K",   4),
    BpfCode.ALU.MOV  | BpfS.X | BpfClass.ALU64:   InstrInfo("FMOV64_X",   4),
    
    ## Only register-register comparisons are supported!
    # ===== FJMP (64-bit compare) =====
    BpfCode.JMP.JEQ  | BpfS.K | BpfClass.JMP:   InstrInfo("JFEQ_K",   22),
    BpfCode.JMP.JEQ  | BpfS.X | BpfClass.JMP:   InstrInfo("JFEQ_X",   18),
    BpfCode.JMP.JGT  | BpfS.K | BpfClass.JMP:   InstrInfo("JFOGT_K",   22),
    BpfCode.JMP.JGT  | BpfS.X | BpfClass.JMP:   InstrInfo("JFOGT_X",   18),
    BpfCode.JMP.JGE  | BpfS.K | BpfClass.JMP:   InstrInfo("JFOGE_K",   22),
    BpfCode.JMP.JGE  | BpfS.X | BpfClass.JMP:   InstrInfo("JFOGE_X",   18),
    BpfCode.JMP.JNE  | BpfS.K | BpfClass.JMP:   InstrInfo("JFNE_K",   22),
    BpfCode.JMP.JNE  | BpfS.X | BpfClass.JMP:   InstrInfo("JFNE_X",   18),
    BpfCode.JMP.JSGT | BpfS.K | BpfClass.JMP:   InstrInfo("JFUGT_K",  22),
    BpfCode.JMP.JSGT | BpfS.X | BpfClass.JMP:   InstrInfo("JFUGT_X",  18),
    BpfCode.JMP.JSGE | BpfS.K | BpfClass.JMP:   InstrInfo("JFUGE_K",  22),
    BpfCode.JMP.JSGE | BpfS.X | BpfClass.JMP:   InstrInfo("JFUGE_X",  18),
    BpfCode.JMP.JLT  | BpfS.K | BpfClass.JMP:   InstrInfo("JFOLT_K",   22),
    BpfCode.JMP.JLT  | BpfS.X | BpfClass.JMP:   InstrInfo("JFOLT_X",   18),
    BpfCode.JMP.JLE  | BpfS.K | BpfClass.JMP:   InstrInfo("JFOLE_K",   22),
    BpfCode.JMP.JLE  | BpfS.X | BpfClass.JMP:   InstrInfo("JFOLE_X",   18),
    BpfCode.JMP.JSLT | BpfS.K | BpfClass.JMP:   InstrInfo("JFULT_K",  22),
    BpfCode.JMP.JSLT | BpfS.X | BpfClass.JMP:   InstrInfo("JFULT_X",  18),
    BpfCode.JMP.JSLE | BpfS.K | BpfClass.JMP:   InstrInfo("JFULE_K",  22),
    BpfCode.JMP.JSLE | BpfS.X | BpfClass.JMP:   InstrInfo("JFULE_X",  18),

    # ===== FJMP32 (32-bit compare) =====
    BpfCode.JMP.JEQ  | BpfS.K | BpfClass.JMP32:   InstrInfo("JFEQ32_K",   22),
    BpfCode.JMP.JEQ  | BpfS.X | BpfClass.JMP32:   InstrInfo("JFEQ32_X",   18),
    BpfCode.JMP.JGT  | BpfS.K | BpfClass.JMP32:   InstrInfo("JFOGT32_K",   22),
    BpfCode.JMP.JGT  | BpfS.X | BpfClass.JMP32:   InstrInfo("JFOGT32_X",   18),
    BpfCode.JMP.JGE  | BpfS.K | BpfClass.JMP32:   InstrInfo("JFOGE32_K",   22),
    BpfCode.JMP.JGE  | BpfS.X | BpfClass.JMP32:   InstrInfo("JFOGE32_X",   18),
    BpfCode.JMP.JNE  | BpfS.K | BpfClass.JMP32:   InstrInfo("JFNE32_K",   22),
    BpfCode.JMP.JNE  | BpfS.X | BpfClass.JMP32:   InstrInfo("JFNE32_X",   18),
    BpfCode.JMP.JSGT | BpfS.K | BpfClass.JMP32:   InstrInfo("JFUGT32_K",  22),
    BpfCode.JMP.JSGT | BpfS.X | BpfClass.JMP32:   InstrInfo("JFUGT32_X",  18),
    BpfCode.JMP.JSGE | BpfS.K | BpfClass.JMP32:   InstrInfo("JFUGE32_K",  22),
    BpfCode.JMP.JSGE | BpfS.X | BpfClass.JMP32:   InstrInfo("JFUGE32_X",  18),
    BpfCode.JMP.JLT  | BpfS.K | BpfClass.JMP32:   InstrInfo("JFOLT32_K",   22),
    BpfCode.JMP.JLT  | BpfS.X | BpfClass.JMP32:   InstrInfo("JFOLT32_X",   18),
    BpfCode.JMP.JLE  | BpfS.K | BpfClass.JMP32:   InstrInfo("JFOLE32_K",   22),
    BpfCode.JMP.JLE  | BpfS.X | BpfClass.JMP32:   InstrInfo("JFOLE32_X",   18),
    BpfCode.JMP.JSLT | BpfS.K | BpfClass.JMP32:   InstrInfo("JFULT32_K",  22),
    BpfCode.JMP.JSLT | BpfS.X | BpfClass.JMP32:   InstrInfo("JFULT32_X",  18),
    BpfCode.JMP.JSLE | BpfS.K | BpfClass.JMP32:   InstrInfo("JFULE32_K",  22),
    BpfCode.JMP.JSLE | BpfS.X | BpfClass.JMP32:   InstrInfo("JFULE_32X",  18)
}
